...
│
└── Smart governance and compliance
    └── Solution 1
        └── Post-Award Contract Change Monitoring System
            ├── backend/     FastAPI + pandas variation engine
            └── frontend/    React + Vite + Recharts dashboard
```
...
over-use anomaly detection). See each solution's README for the full problem
statement, architecture, and run instructions.